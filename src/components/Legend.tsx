...
export default function Legend() {
	return (
		<div className='legend'>
			<Label as='div' size='md' className='legend-title'>
				LINES ON THE GLOBE
			</Label>
			...
			<div className='legend-row'>
				...
				<Label size='md' className='legend-angle'>
					−0.8°
				</Label>
			</div>
			...
			<p className='legend-note'>
				One boundary, two limbs: gold where the sun is coming up, lavender where it is going down. They meet at
				the far north and south. The pulses mark the exact points the sun and moon stand over; their glyphs ride
				outside the earth.
			</p>
		</div>
	);
